...
class ManageAllTasks2Controller extends AdminBaseController
{
    use ProjectProgress;
    ...
    public function index(AllTasksDataTable $dataTable)
    {
        ...
        // return view('admin.tasks2.index', $this->data);
        return $dataTable->render('admin.tasks2.index', $this->data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.tasks2.edit', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.tasks2.create', $this->data);
    }

    public function membersList($projectId)
    {
        $this->members = ProjectMember::byProject($projectId);
        $list = view('admin.tasks2.members-list', $this->data)->render();
    ...
    public function dependentTaskLists($projectId, $taskId = null)
    {
        ...
        $list = view('admin.tasks2.dependent-task-list', $this->data)->render();
        return Reply::dataOnly(['html' => $list]);
    }
    ...
    public function ajaxCreate(Request $request, $columnId)
    {
        ...
        return view('admin.tasks2.ajax_create', $this->data);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        $this->fields = $this->task->getCustomFieldGroupsWithFields()->fields;
        $this->type = ($request->has('type')) ? $request->type : '';
        $view = view('admin.tasks2.show', $this->data)->render();
    ...
    public function showFiles($id)
    {
        ...
        return view('admin.tasks2.ajax-file-list', $this->data);
    }

    public function history($id)
    {
        $this->task = Task::with('board_column', 'history', 'history.board_column')->findOrFail($id);
        $view = view('admin.tasks2.history', $this->data)->render();
        return Reply::dataOnly(['status' => 'success', 'view' => $view]);
    }
    ...
    public function pinnedItem()
    {
        ...
        return view('admin.tasks2.pinned-task', $this->data);
    }
