...
class AdminCalendar2Controller extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return view('admin.task-calendar2.index', $this->data);
    }

    public function show($id)
    {
        $this->task = Task::findOrFail($id);
        return view('admin.task-calendar2.show', $this->data);
    }
