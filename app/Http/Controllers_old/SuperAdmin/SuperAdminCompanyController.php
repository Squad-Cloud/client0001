    ...
    public function data(Request $request)
    {
        ...
        return Datatables::of($packages)
            ->addColumn('action', function ($row) {
                ...
                $action .= '<li><a href="javascript:;" data-user-id="' . $row->id . '" class="sa-params"><i class="fa fa-trash" aria-hidden="true"></i> ' . trans('app.delete') . '</a></li>';
            ...
            ->addColumn('details', function ($row) {
                ...
                if ($companyUser && $companyUser->email_verification_code == null) {
                    ...
                    $verified = '<i class="fa fa-trash" style="color: red;"></i>';
                } else {
                    $verified = '-';
                }
