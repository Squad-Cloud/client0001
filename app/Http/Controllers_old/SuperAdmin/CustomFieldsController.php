    ...
    public function getFields()
    {
        ...
        $data = DataTables::of($permissions)
            ...
            ->addColumn(
                'action',
                function ($row) {
                    return '<a href="javascript:;" class="icon-style edit-custom-field"
                    data-toggle="tooltip" data-user-id="' . $row->id . '" data-original-title="' . __('app.edit') . '"><i class="fa fa-edit" aria-hidden="true"></i></a>  <a href="javascript:;" class="icon-style sa-params"
