...
class ManageProjects2Controller extends AdminBaseController
{
    ...
    public function index(ProjectsDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.projects2.index', $this->data);
    }
    ...
    public function archive()
    {
        ...
        $this->clients = User::allClients();
        return view('admin.projects2.archive', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.projects2.create', $this->data);
    }
    ...
    public function store(StoreProject $request)
    {
        ...
        $this->logSearchEntry($project->id, 'Project: ' . $project->project_name, 'admin.projects2.show', 'project');
        ...
        //return Reply::redirect(route('admin.projects2.index'), __('modules.projects.projectUpdated'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.projects2.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->fields = $this->project->getCustomFieldGroupsWithFields()->fields;
        $this->currencies = Currency::all();
        return view('admin.projects2.edit', $this->data);
    }
    ...
    * @param  int $id
    ...
    public function update(UpdateProject $request, $id)
    {
        ...
        return Reply::redirect(route('admin.projects2.index'), __('messages.projectUpdated'));
    }
    ...
    public function gantt($ganttProjectId = '')
    {
        ...
        return view('admin.projects2.gantt', $this->data);
    }
    ...
    public function burndownChart(Request $request, $id)
    {
        ...
        return view('admin.projects2.burndown', $this->data);
    }
    ...
    public function discussion(DiscussionDataTable $dataTable, $projectId)
    {
        ...
        return $dataTable->with('project_id', $projectId)->render('admin.projects2.discussion.show', $this->data);
    }
    ...
    public function discussionReplies($projectId, $discussionId)
    {
        ...
        return view('admin.projects2.discussion.replies', $this->data);
    }
    ...
    public function pinnedItem()
    {
        ...
        return view('admin.projects2.pinned-project', $this->data);
    }
