                ...
                <div class="col-xs-12" id="estimates">
                    <div class="row m-b-20">
                        <div class="col-xs-12">
                            ...
                            <a href="{{ route("admin.contracts2.download", $contract->id) }}" class="btn btn-default pull-right m-r-10"><i class="fa fa-file-pdf-o"></i> @lang('app.download')</a>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="card">
...
<script>
    ...
    //Accept estimate
    function sign() {
        var url = '{{ route('admin.contracts2.sign-modal', $contract->id) }}';
