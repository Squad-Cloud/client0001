...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-10 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.all-time-logs2.active-timelogs') }}"
            ...
            <a href="{{ route('admin.all-time-logs2.calendar') }}"
            ...
            <a href="{{ route('admin.all-time-logs2.by-employee') }}"
...
<script>
    ...
    $('#project_id2').change(function () {
        var id = $(this).val();
        var url = '{{route('admin.all-time-logs2.members', ':id')}}';
    ...
    $('#task_id2').change(function () {
        var id = $(this).val();
        var url = '{{route('admin.all-time-logs2.task-members', ':id')}}';
        url = url.replace(':id', id);
        // $('#employeeBox').show();
        $.easyAjax({
            url: url,
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('admin.all-time-logs2.destroy',':id') }}";
                url = url.replace(':id', id);
    ...
    $('body').on('click', '.approve-timelog', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('admin.all-time-logs2.approve-timelog') }}";
    ...
    $('#timer-list').on('click', '.stop-timer', function () {
        var id = $(this).data('time-id');
        var url = '{{route('admin.all-time-logs2.stopTimer', ':id')}}';
        url = url.replace(':id', id);
        var token = '{{ csrf_token() }}';
        $.easyAjax({
            url: url,
    ...
    function exportTimeLog(){
        ...
        var url = '{{ route('admin.all-time-logs2.export', [':startDate', ':endDate', ':projectId', ':employee']) }}';
