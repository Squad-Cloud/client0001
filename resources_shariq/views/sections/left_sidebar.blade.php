...
<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            @if(in_array('projects', $modules) || in_array('tasks', $modules) || in_array('timelogs', $modules) || in_array('contracts', $modules))
            <li><a href="{{ route('admin.task.index') }}" class="waves-effect"><i class="icon-layers fa-fw"></i> <span class="hide-menu"> @lang('app.menu.case_management') <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
                    @if(in_array('contracts', $modules))
                        <li><a href="{{ route('admin.contracts2.index') }}" class="waves-effect">@lang('app.menu.contracts')</a></li>
                    @endif
                    @if(in_array('projects',$modules))
                        <li><a href="{{ route('admin.projects2.index') }}" class="waves-effect">@lang('app.menu.projects') </a> </li>
                    @endif
                    @if(in_array('tasks',$modules))
                        <li><a href="{{ route('admin.all-tasks2.index') }}">@lang('app.menu.taskss')</a></li>
                        <li class=""><a href="{{ route('admin.taskboard2.index') }}">@lang('modules.tasks.activityBoard')</a></li>
                        <li><a href="{{ route('admin.task-calendar2.index') }}">@lang('app.menu.activityCalendar')</a></li>
                    @endif
                    @if(in_array('timelogs',$modules))
                        <li><a href="{{ route('admin.all-time-logs2.index') }}" class="waves-effect">@lang('app.menu.timeLogs')</a> </li>
                    @endif
