...
class ManageAllTimeLog2Controller extends AdminBaseController
{
    ...
    public function index(AllTimeLogsDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.time-logs2.index', $this->data);
        // return view('admin.time-logs2.index', $this->data);
    }
    ...
    public function byEmployee()
    {
        ...
        return view('admin.time-logs2.by_employee', $this->data);
    }
    ...
    public function showActiveTimer()
    {
        ...
        return view('admin.time-logs2.show-active-timer', $this->data);
    }
    ...
    public function data(Request $request)
    {
        ...
        $this->employees = $this->employees->groupBy('project_time_logs.user_id')
            ->orderBy('users.name')
            ->get();
        $html = view('admin.time-logs2.members-list', $this->data)->render();
    ...
    public function userTimelogs(Request $request)
    {
        ...
        $html = view('admin.time-logs2.user-timelogs', $this->data)->render();
        return Reply::dataOnly(['html' => $html]);
    }
    ...
    public function activeTimelogs(ActiveTimeLogsDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.time-logs2.active', $this->data);
    }
    ...
    public function calendar()
    {
        ...
        return view('admin.time-logs2.calendar', $this->data);
    }
