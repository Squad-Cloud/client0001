...
class AdminContract2Controller extends AdminBaseController
{
    ...
    public function __construct()
    {
        ...
        $this->pageTitle = 'app.menu.contracts2';
    ...
    public function index(ContractsDataTable $dataTable)
    {
        ...
        $this->aboutToExpireCounts = Contract::where(DB::raw('DATE(`end_date`)'), '>', Carbon::now()->format('Y-m-d'))
            ...
            ->count();
        return $dataTable->render('admin.contracts2.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.contracts2.create', $this->data);
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        if ($contract != null) {
            return Reply::redirect(route('admin.contracts2.edit', $contract->id), __('messages.contractAdded'));
        }
    ...
    public function edit($id)
    {
        ...
        $this->upload = can_upload();
        return view('admin.contracts2.edit', $this->data);
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return Reply::redirect(route('admin.contracts2.index'), __('messages.contractUpdated'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.contracts2.view', $this->data);
    }
    ...
    public function download($id)
    {
        ...
        $pdf->loadView('admin.contracts2.contract-pdf', $this->data);
    ...
    public function addDiscussion(StoreDiscussionRequest $request, $id)
    {
        ...
        return Reply::redirect(route('admin.contracts2.show', md5($id) . '#discussion'), __('messages.addDiscussion'));
    }

    public function contractSignModal($id)
    {
        $this->contract = Contract::find($id);
        return view('admin.contracts2.accept', $this->data);
    }
    ...
    public function contractSign(SignRequest $request, $id)
    {
        ...
        return Reply::redirect(route('admin.contracts2.show', md5($this->contract->id)));
    }

    public function editDiscussion($id)
    {
        $this->discussion = ContractDiscussion::find($id);
        return view('admin.contracts2.edit-discussion', $this->data);
    }
    ...
    public function copy($id)
    {
        ...
        $this->contractType = ContractType::all();
        $this->contract = Contract::with('signature', 'renew_history', 'renew_history.renewedBy')->find($id);
        return view('admin.contracts2.copy', $this->data);
    }
