...
class AdminTaskboard2Controller extends AdminBaseController
{
    use ProjectProgress;
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $view = view('admin.taskboard2.board_data', $this->data)->render();
            return Reply::dataOnly(['view' => $view]);
        }
        return view('admin.taskboard2.index', $this->data);
    }
    ...
    {
        return view('admin.taskboard2.create', $this->data);
    }
    ...
    public function store(StoreTaskBoard $request)
    {
        ...
        return Reply::redirect(route('admin.taskboard2.index'), __('messages.boardColumnSaved'));
    }
    ...
    public function edit($id)
    {
        ...
        //        $view =  view('admin.taskboard2.edit', $this->data)->render();
        //        return Reply::dataOnly(['view' => $view]);
        return view('admin.taskboard2.edit', $this->data)->render();
    }
