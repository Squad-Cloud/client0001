                                                ...
                                                @forelse($features as $feature)
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap">
                                                            <a href="javascript:;" data-feature-id="{{ $feature->id }}" class="icon-style editFeature"
                                                            ...
                                                            <a href="javascript:;" class="icon-style sa-params"
                                                               data-toggle="tooltip" data-feature-id="{{ $feature->id }}" data-original-title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                 @empty
                                                    <tr>
