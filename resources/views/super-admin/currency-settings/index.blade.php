                                                ...
                                                @foreach($currencies as $currency)
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap">
                                                            @if($global->currency_converter_key)
                                                            <a href="{{ route('super-admin.currency.edit', [$currency->id]) }}" class="icon-style"
                                                            ...
                                                            <a href="javascript:;" class="icon-style sa-params"
                                                               data-toggle="tooltip" data-currency-id="{{ $currency->id }}" data-original-title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
