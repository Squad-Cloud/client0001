                            ...
                            @foreach($languages as $language)
                                <tr id="languageRow{{ $language->id }}">
                                    ...
                                    <td class="text-nowrap">
                                        <a href="{{ route('super-admin.language-settings.edit', [$language->id]) }}" class="icon-style"
                                           data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a>

                                        <a href="javascript:;" class="icon-style sa-params"
                                           data-toggle="tooltip" data-language-id="{{ $language->id }}" data-original-title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
