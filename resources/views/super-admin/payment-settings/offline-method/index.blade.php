                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:;" data-type-id="{{ $method->id }}"
                                                               class="icon-style edit-type m-t-5" data-toggle="tooltip"data-original-title="Edit"><i
                                                                        class="fa fa-edit"></i></a>
                                                            <a href="javascript:;" data-type-id="{{ $method->id }}"
                                                               class="icon-style delete-type m-t-5" data-toggle="tooltip"data-original-title="Delete"><i
