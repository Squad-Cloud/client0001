                                            ...
                                            @forelse($frontFeatures as $feature)
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">
                                                        <a href="javascript:;" data-front-feature-id="{{ $feature->id }}" class="icon-style editFrontFeature"
                                                            data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                        <a href="{{ route('super-admin.front-feature-settings.show',$feature->id ) }}"  class="icon-style"
                                                            data-toggle="tooltip" data-original-title="View And Add Feature"><i class="fa fa-search" aria-hidden="true"></i></a>
                                                        <a href="javascript:;" class="icon-style sa-params-feature"
                                                            data-toggle="tooltip" data-front-feature-id="{{ $feature->id }}" data-original-title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
