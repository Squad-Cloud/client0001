...
<div id="auth-logo">
    ...
    <form class="form-horizontal form-material" id="loginform" action="{{ route('login') }}" method="POST" style="padding: 0 100px">
        {{ csrf_field() }}
        ...
        @endif
        <p style="font-size: 20px; font-weight: 600;text-align:center">Sign in to your account</p>
        <p style="text-align:center; padding: 2px 10px 10px">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo ipsa dolores esse voluptatem? Amet quae</p>
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <div class="display: flex; align-items: center; justify-conten: space-between">
...
{{--        @php dd($global); @endphp--}}
        ...
        <div class="form-group text-center m-t-20">
            <div class="col-xs-12">
                <button class="btn btn-lg btn-block btn-rounded text-uppercase waves-effect waves-light" style="background-color: #78150d; color: #fff;"
