...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.all-time-logs2.index') }}" class="btn btn-outline btn-primary btn-sm">@lang('modules.leaves.tableView') </a>
            <ol class="breadcrumb">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: "{{ route('admin.all-time-logs2.calendar') }}"
      });
