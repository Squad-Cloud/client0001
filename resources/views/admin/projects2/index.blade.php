...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            ...
            <a href="{{ route('admin.projects2.create') }}" class="btn btn-outline btn-success btn-sm">@lang('app.add') <i class="fa fa-plus" aria-hidden="true"></i></a>
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('admin.projects2.destroy',':id') }}";
                    url = url.replace(':id', id);
