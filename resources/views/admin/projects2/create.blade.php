    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">@lang('modules.projects.createTitleCase')
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            <h3 class="box-title m-b-10">@lang('modules.projects.caseInfo')</h3>
                            <div class="row">
                                <div class="col-xs-12 col-md-6 ">
                                    <div class="form-group">
                                        <label class="required">@lang('modules.projects.caseName')
                                            <a class="mytooltip" href="javascript:void(0)">
                                                <i class="fa fa-info-circle"></i>
                                                <span class="tooltip-content5">
                                                    <span class="tooltip-text3">
                                                        <span class="tooltip-inner2">@lang('help_text.caseName')</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </label>
                                ...
                                <div class="col-xs-12 col-md-6 ">
                                    <div class="form-group">
                                        <label class="control-label">@lang('modules.projects.caseCategory')

                                            <a class="mytooltip" href="javascript:void(0)">
                                                <i class="fa fa-info-circle"></i>
                                                <span class="tooltip-content5">
                                                    <span class="tooltip-text3">
                                                        <span class="tooltip-inner2">@lang('help_text.caseCategorySettings')</span>
                                                    </span>
                                                </span>
                                            </a>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label class="required">@lang('modules.projects.startDate')
                                            <a class="mytooltip" href="javascript:void(0)">
                                                ...
                                                <span class="tooltip-content5">
                                                    <span class="tooltip-text3">
                                                        <span class="tooltip-inner2">@lang('help_text.startDateCase')</span>
                                                    </span>
                                                </span>
                                            </a>
                                        </label>
                                ...
                                <div class="col-md-4" id="caseCitationBox">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.caseCitation')</label>
                                        <input type="text" name="caseCitation" id="caseCitation" autocomplete="off" class="form-control">
                                    </div>
                                </div>

                                <div class="col-md-4" id="caseLocationBox">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.caseLocation')</label>
                                        <input type="text" name="caseLocation" id="caseLocation" autocomplete="off" class="form-control">
                                    </div>
                                </div>

                                <div class="col-md-4" id="caseCourtBox">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.caseCourt')</label>
                                        <input type="text" name="caseCourt" id="caseCourt" autocomplete="off" class="form-control">
                                    </div>
                                </div>

                                <div class="col-md-4" id="practiceAreaBox">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.practiceArea')</label>
                                        <input type="text" name="practiceArea" id="practiceArea" autocomplete="off" class="form-control">
                                    </div>
                                </div>

                                <div class="col-md-4" id="caseStageBox">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.caseStage')</label>
                                        <input type="text" name="caseStage" id="caseStage" autocomplete="off" class="form-control">
                                    </div>
                                </div>

                                <div class="col-md-4" id="keyHearingDates">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.keyHearingDates')</label>
                                        <input type="date" name="keyHearingDates" id="keyHearingDates" autocomplete="off" class="form-control">
                                    </div>
                                </div>

                                <div class="col-md-4" id="originatingAttorney">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.originatingAttorney')</label>
                                        <input type="text" name="originatingAttorney" id="originatingAttorney" autocomplete="off" class="form-control">
                                    </div>
                                </div>

                                <div class="col-md-4" id="responsibleAttorney">
                                    <div class="form-group">
                                        <label>@lang('modules.projects.responsibleAttorney')</label>
                                        <input type="text" name="responsibleAttorney" id="responsibleAttorney" autocomplete="off" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12">
                                    <div class="form-group" id="user_id">
                                        <label class="required">@lang('modules.projects.addCaseMemberTitle')</label>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label">@lang('modules.projects.caseSummary')</label>
