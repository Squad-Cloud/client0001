...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="{{ route('admin.contracts2.show', md5($contract->id)) }}" class="btn btn-sm btn-info btn-outline  pull-right">@lang('app.view') @lang('app.menu.contract')</a>

            <ol class="breadcrumb">
                <li><a href="{{ route('admin.dashboard') }}">@lang('app.menu.home')</a></li>
                <li><a href="{{ route('admin.contracts2.index') }}">{{ __($pageTitle) }}</a></li>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center m-t-15 m-b-15">
            <a href="{{ route('admin.contracts2.index') }}" class="btn btn-inverse waves-effect waves-light m-r-10">@lang('app.back')</a>
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('admin.contracts2.update', $contract->id)}}',
        ...
        function  renewContract() {
            var url = '{{ route('admin.contracts2.renew', $contract->id)}}';
            $.ajaxModal('#taskCategoryModal',url);
        }
        ...
        function  removeHistory(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = '{{ route('admin.contracts2.renew-remove', ':id') }}';
