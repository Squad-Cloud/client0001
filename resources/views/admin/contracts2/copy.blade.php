        ...
        <div class="col-md-6">
            <div class="white-box">
                <h3 class="box-title m-b-0">{{ $contract->subject }}
                    <a href="{{ route('admin.contracts2.show', md5($contract->id)) }}" target="_blank" class="btn btn-sm btn-default pull-right">View Contract</a>
                </h3>
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('admin.contracts2.copy-submit')}}',
