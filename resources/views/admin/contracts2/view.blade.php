...
<div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a class="btn btn-info btn-outline btn-sm"
                href="{{ route("admin.contracts2.edit", $contract->id) }}"> <span><i class="fa fa-edit"></i> @lang('app.edit')</span> </a>
            <a class="btn btn-default btn-outline btn-sm"
                href="{{ route("admin.contracts2.download", $contract->id) }}"> <span><i class="fa fa-file-pdf-o"></i> @lang('modules.invoices.downloadPdf')</span> </a>
        </div>
        <!-- /.breadcrumb -->
    </div>
...
<script>
    ...
    function addDiscussion() {
        $.easyAjax({
            type:'POST',
            url:'{{route('admin.contracts2.add-discussion', $contract->id)}}',
            container:'#estimates',
    ...
    //Accept estimate
    function edit(id) {
        var url = '{{ route('admin.contracts2.edit-discussion', ':id') }}';
    ...
    $('body').on('click', '.remove-discussion', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('admin.contracts2.remove-discussion',':id') }}";
                url = url.replace(':id', id);
