    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('admin.all-tasks2.index') }}">{{ __($pageTitle) }}</a></li>
...
@push('footer-script')
    ...
    <script>
        ...
        @if($upload)
            ...
            window.location.href = '{{ route('admin.all-tasks2.index') }}'
        ...
        $('#store-task').click(function () {
            $.easyAjax({
                url: '{{route('admin.all-tasks2.store')}}',
                container: '#storeTask',
                type: "POST",
        ...
        $('#project_id').change(function () {
            var id = $(this).val();
            var url = '{{route('admin.all-tasks2.members', ':id')}}';
            url = url.replace(':id', id);
            ...
            var dependentTaskUrl = '{{route('admin.all-tasks2.dependent-tasks', ':id')}}';
