    ...
    Route::group(
        ...
        function () {
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                //code by shariq
                Route::resource('projects2', 'ManageProjects2Controller');
                ...
                // code by shariq
                Route::get('all-time-logs/members/{projectId}', ['uses' => 'ManageAllTimeLog2Controller@membersList'])->name('all-time-logs2.members');
                ...
                //code by shariq
                Route::get('all-time-logs/task-members/{taskId}', ['uses' => 'ManageAllTimeLog2Controller@taskMembersList'])->name('all-time-logs2.task-members');
                ...
                //code by shariq
                Route::get('all-time-logs/export/{startDate?}/{endDate?}/{projectId?}/{employee?}', ['uses' => 'ManageAllTimeLog2Controller@export'])->name('all-time-logs2.export');
                Route::post('all-time-logs/stop-timer/{id}', ['uses' => 'ManageAllTimeLogController@stopTimer'])->name('all-time-logs.stopTimer');
                //code by shariq
                Route::post('all-time-logs/stop-timer/{id}', ['uses' => 'ManageAllTimeLog2Controller@stopTimer'])->name('all-time-logs2.stopTimer');
                Route::post('all-time-logs/data', ['uses' => 'ManageAllTimeLogController@data'])->name('all-time-logs.data');
                //code by shariq
                Route::post('all-time-logs/data', ['uses' => 'ManageAllTimeLog2Controller@data'])->name('all-time-logs2.data');
                Route::get('all-time-logs/by-employee', ['uses' => 'ManageAllTimeLogController@byEmployee'])->name('all-time-logs.by-employee');
                Route::get('all-time-logs/by-employee', ['uses' => 'ManageAllTimeLog2Controller@byEmployee'])->name('all-time-logs2.by-employee');
                Route::post('all-time-logs/userTimelogs', ['uses' => 'ManageAllTimeLogController@userTimelogs'])->name('all-time-logs.userTimelogs');
                //code by shariq
                Route::post('all-time-logs/userTimelogs', ['uses' => 'ManageAllTimeLog2Controller@userTimelogs'])->name('all-time-logs2.userTimelogs');
                ...
                //code by shariq
                Route::post('all-time-logs/approve-timelog', ['uses' => 'ManageAllTimeLog2Controller@approveTimelog'])->name('all-time-logs2.approve-timelog');
                ...
                Route::get('all-time-logs/active-timelogs', ['uses' => 'ManageAllTimeLog2Controller@activeTimelogs'])->name('all-time-logs2.active-timelogs');
                Route::get('all-time-logs/calendar', ['uses' => 'ManageAllTimeLogController@calendar'])->name('all-time-logs.calendar');
                Route::get('all-time-logs/calendar', ['uses' => 'ManageAllTimeLog2Controller@calendar'])->name('all-time-logs2.calendar');
                Route::resource('all-time-logs', 'ManageAllTimeLogController');
                //code by shariq
                Route::resource('all-time-logs2', 'ManageAllTimeLog2Controller');
                // task routes
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        //code by shariq
                        Route::get('all-tasks/export/{startDate?}/{endDate?}/{projectId?}/{hideCompleted?}', ['uses' => 'ManageAllTasks2Controller@export'])->name('all-tasks2.export');
                        ...
                        //code by shariq
                        Route::get('all-tasks/dependent-tasks/{projectId}/{taskId?}', ['uses' => 'ManageAllTasks2Controller@dependentTaskLists'])->name('all-tasks2.dependent-tasks');
                        ...
                        //code by shariq
                        Route::get('all-tasks/pinned-task', ['uses' => 'ManageAllTasks2Controller@pinnedItem'])->name('all-tasks2.pinned-task');
                        Route::resource('all-tasks', 'ManageAllTasksController');
                        // code by shariq
                        Route::resource('all-tasks2', 'ManageAllTasks2Controller');
                        //task request 
                        ...
                        //code by shariq
                        Route::post('taskboard/getMilestone', ['uses' => 'AdminTaskboard2Controller@getMilestone'])->name('taskboard2.getMilestone');
                        ...
                        //code by shariq
                        Route::resource('taskboard2', 'AdminTaskboard2Controller');
                        // task calendar routes
                        Route::resource('task-calendar', 'AdminCalendarController');
                        // code by shariq
                        Route::resource('task-calendar2', 'AdminCalendar2Controller');
                ...
                //code by shariq
                Route::resource('contracts2', 'AdminContract2Controller');
        ...
        function () {
            ...
            Route::group(
                ...
                function () {
                    ...
                    Route::get('all-tasks/members/{projectId}', ['uses' => 'MemberAllTasks2Controller@membersList'])->name('all-tasks2.members');
